...
export default function ApplyPage() {
  return (
    <main className="mx-auto w-full max-w-5xl px-6 py-20">
      ...
      <p className="mt-4 max-w-xl text-lg text-zinc-600">Select a role to apply for</p>
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <Link href="/apply/judge" className="rounded-xl border border-zinc-200 p-8 hover:border-green-600 hover:bg-green-50">
          ...
          <p className="mt-3 text-zinc-600">Share your experience and grade submissions.</p>
        </Link>
